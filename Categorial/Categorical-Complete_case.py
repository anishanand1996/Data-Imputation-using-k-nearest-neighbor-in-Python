...
for f in csv_files:
    ...
    real = pd.read_excel( r'D:\Anisha\UNIVERSITY OF WINDSOR\Semester 3\Data mining\Project\Dataset and instructions\Original Datasets\Original Datasets Without Labels\TTTTEG.xlsx',
        header=None)
