...
nrms=pd.read_excel(r'C:\Users\Anisha\Desktop\Table-NRMS-AE.xlsx')
...
path = r'D:\Anisha\UNIVERSITY OF WINDSOR\Semester 3\Data mining\Project\Dataset and instructions\Incomplete Datasets\Incomplete Datasets Without Labels\Letter'
...
for f in csv_files:
    ...
    real = pd. read_excel(r'D:\Anisha\UNIVERSITY OF WINDSOR\Semester 3\Data mining\Project\Dataset and instructions\Original Datasets\Original Datasets Without Labels\Letter.xlsx', header=None)
...
pd.DataFrame(nrmsArray).to_excel(r'C:\Users\Anisha\Desktop\Table-NRMS-AE.xlsx',index=False)